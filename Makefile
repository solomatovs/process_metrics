...
USER_SRCS  := $(SRCDIR)/process_metrics.c $(SRCDIR)/pm_config.c $(SRCDIR)/pm_rules.c $(SRCDIR)/refresh.c $(SRCDIR)/snapshot.c $(SRCDIR)/event_file.c $(SRCDIR)/http_server.c $(SRCDIR)/csv_format.c
